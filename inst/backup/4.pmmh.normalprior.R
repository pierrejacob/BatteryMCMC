...
foreach(i = 1:n, .combine = c) %dopar% {
  ...
  load(file = paste0("Results/", filenames[i], "_model1_normalprior_preliminary.RData"))
  ...
  save(results, file = paste0("Results/", filenames[i], "_model1_normalprior_pmmh.RData"))

  load(file = paste0("Results/", filenames[i], "_model2_normalprior_preliminary.RData"))
  ...
  save(results, file = paste0("Results/", filenames[i], "_model2_normalprior_pmmh.RData"))
  1
}
